...
const docTemplate = `{
    ...
    "paths": {
        "/api/v1/catalogo/especies": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.EspecieArbol"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datos para crear la especie",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateEspecieArbolRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/catalogo/especies/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID de la especie (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateEspecieArbolRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/catalogo/estados-agua": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.EstadoAgua"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datos para crear el estado de agua",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateEstadoAguaRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/catalogo/estados-agua/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID del estado (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateEstadoAguaRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/catalogo/estados-arbol": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.EstadoArbol"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datos para crear el estado de árbol",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateEstadoArbolRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/catalogo/estados-arbol/{id}": {
            "get": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateEstadoArbolRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/catalogo/estados-estanque": {
            "get": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.EstadoEstanque"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datos para crear el estado de estanque",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateEstadoEstanqueRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/catalogo/estados-estanque/{id}": {
            "get": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateEstadoEstanqueRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/catalogo/tipos-sensor": {
                                ...
                                },
                                {
                                    ...
                                    "properties": {
                                        "data": {
                                            "type": "array",
                                            "items": {
                                                "$ref": "#/definitions/model.TipoSensor"
                                            }
                                        }
                                    }
                                }
            ...
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Datos para crear el tipo de sensor",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateTipoSensorRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/v1/catalogo/tipos-sensor/{id}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "ID del tipo de sensor (UUID)",
                        "name": "id",
                        "in": "path",
                        "required": true
                    }
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.UpdateTipoSensorRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        "model.CreateEspecieArbolRequest": {
            "type": "object",
            "properties": {
                "activo": {
                    "type": "boolean"
        ...
        "model.CreateEstadoArbolRequest": {
            "type": "object",
            "properties": {
                "codigo": {
                    "type": "string"
        ...
        "model.CreateEstadoEstanqueRequest": {
            "type": "object",
            "properties": {
                "codigo": {
                    "type": "string"
        ...
        "model.UpdateEspecieArbolRequest": {
            "type": "object",
            "properties": {
                "activo": {
                    "type": "boolean"
        ...
        "model.UpdateEstadoArbolRequest": {
            "type": "object",
            "properties": {
                "codigo": {
                    "type": "string"
        ...
        "model.UpdateEstadoEstanqueRequest": {
            "type": "object",
            "properties": {
                "codigo": {
                    "type": "string"
